      ...
      <div className="flex flex-col items-center justify-center min-h-screen bg-white dark:bg-zinc-950 p-4 text-center relative overflow-hidden transition-colors duration-300">
        ...
        >
          ...
          <button
            ...
            className="w-full mt-4 py-4 sm:py-5 bg-zinc-100 dark:bg-zinc-800 hover:bg-zinc-200 dark:hover:bg-zinc-700 text-zinc-900 dark:text-zinc-100 rounded-2xl font-bold transition-all active:scale-[0.98] flex items-center justify-center gap-4 text-base sm:text-lg border border-zinc-200 dark:border-zinc-700 shadow-lg outline-none focus:ring-4 focus:ring-zinc-500/20 font-display"
          >
      ...
      `}>
        ...
        <div className="p-6 mt-auto relative z-10 shrink-0">
          {user.uid === 'local_guest' ? (
            <button
              onClick={signIn}
              className="w-full flex items-center justify-center gap-2 px-4 py-3 mb-4 rounded-xl bg-indigo-600 text-white font-bold text-sm hover:bg-indigo-700 transition-all shadow-md shadow-indigo-500/20 active:scale-95 font-display"
            >
              Sign In with Google
            </button>
          ) : (
